<script type="text/javascript">
	jQuery(document).ready(function($) {
		$("#wpsms-submit").click(function() {
			...
			$("#wpsms-result").html('<img src="<?php bloginfo('url'); ?>/wp-content/plugins/tikab-sms/images/loading.gif"/>');
		...
		$("#activation").live('click', function() {
			...
			$("#show_result_activation").html('<img src="<?php bloginfo('url'); ?>/wp-content/plugins/tikab-sms/images/loading.gif"/>');
...
<table id="wpsms-subscribe">
	...
	<tr>
		<td colspan="2"><?php _e('Enter your information for SMS Subscribe', 'tikab-sms'); ?></td>
	</tr>

	<tr>
		<td><?php _e('Name', 'tikab-sms'); ?>:</td>
		<td><input class="wpsms-input" type="text" id="wpsms-name"/></td>
	</tr>

	<tr>
		<td><?php _e('Mobile', 'tikab-sms'); ?>:</td>
		<td><input class="wpsms-input" type="text" id="wpsms-mobile"/></td>
	</tr>
	
	<tr>
		<td><?php _e('Group', 'tikab-sms'); ?>:</td>
		<td>
	...
	<tr>
		<td colspan="2">
			...
			<label for="wpsms-type-subscribe"><?php _e('Subscribe', 'tikab-sms'); ?></label>

			<input type="radio" name="subscribe_type" id="wpsms-type-unsubscribe" value="unsubscribe"/>
			<label for="wpsms-type-unsubscribe"><?php _e('Unsubscribe', 'tikab-sms'); ?></label>
		</td>
	</tr>

	<tr>
		<td colspan="2">
			<button class="wpsms-submit" id="wpsms-submit"><?php _e('Subscribe', 'tikab-sms'); ?></button>
	...
	<tr>
		<td colspan="2">
		<p align="center"><img src="<?php bloginfo('url'); ?>/wp-content/plugins/tikab-sms/images/close.png"/></p>
		<?php _e('Subscribe is Deactive!', 'tikab-sms'); ?>
		</td>
	</tr>
	<?php } ?>
</table>