<div id="sms-sortables" class="meta-box-sortables ui-sortable">
	<div id="maildiv" class="postbox">
		...
		<h3 class="hndle"><span><?php _e('SMS', 'tikab-sms'); ?></span></h3>
		
		<div class="inside">
			<div class="mail-fields">
				<div class="half-left">
					<div class="mail-field">
						<label for="wpcf7-sms-recipient"><?php _e('Send to', 'tikab-sms'); ?>:</label><br/>
						<input type="text" id="wpcf7-sms-recipient" name="wpcf7-sms[phone]" class="wide" size="70" value="<?php echo $options['phone']; ?>"/>
						<p class="description"><?php _e('Enter enter mobile number to receive message.', 'tikab-sms'); ?></p>
					</div>
				</div>

				<div class="half-right">
					<div class="mail-field">
						<label for="wpcf7-mail-body"><?php _e('Message body', 'tikab-sms'); ?>:</label><br/>
